...
var _h3TileLayer = _interopRequireDefault(require("./h3-tile-layer"));

var _quadbinTileLayer = _interopRequireDefault(require("./quadbin-tile-layer"));
...
var CartoLayer = function (_CompositeLayer) {
  ...
  (0, _createClass2.default)(CartoLayer, [{
    ...
    value: function _getSubLayerAndProps() {
      ...
      if (data.scheme === 'h3') {
        return [_h3TileLayer.default, props];
      }

      if (data.scheme === 'quadbin') {
        return [_quadbinTileLayer.default, props];
      }
