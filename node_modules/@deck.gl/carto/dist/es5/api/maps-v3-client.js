...
function fillInMapDatasets(_x11, _x12, _x13) {
  return _fillInMapDatasets.apply(this, arguments);
}

function _fillInMapDatasets() {
  _fillInMapDatasets = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee8(_ref10, clientId, credentials) {
...
function fetchMap(_x14) {
  return _fetchMap.apply(this, arguments);
}

function _fetchMap() {
  _fetchMap = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee10(_ref11) {
    ...
    return _regenerator.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            cartoMapId = _ref11.cartoMapId, clientId = _ref11.clientId, credentials = _ref11.credentials, autoRefresh = _ref11.autoRefresh, onNewData = _ref11.onNewData;
            defaultCredentials = (0, _config.getDefaultCredentials)();
            localCreds = _objectSpread(_objectSpread({}, defaultCredentials.apiVersion === _mapsApiCommon.API_VERSIONS.V3 && defaultCredentials), credentials);
            accessToken = localCreds.accessToken;
          ...
          case 12:
            ...
            if (autoRefresh) {
              intervalId = setInterval((0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee9() {
                var changed;
            ...
            geojsonLayers = map.keplerMapConfig.config.visState.layers.filter(function (_ref13) {
              var type = _ref13.type;
              return type === 'geojson' || type === 'point';
            });
            geojsonDatasetIds = geojsonLayers.map(function (_ref14) {
          ...
          case 19:
            return _context10.abrupt("return", _objectSpread(_objectSpread({}, (0, _parseMap.parseMap)(map)), {
